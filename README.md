This is a dynamic News Website built using Python Flask, HTML, CSS, and JavaScript. It includes user authentication, a searchable news interface, and fetches news from a MySQL database.
